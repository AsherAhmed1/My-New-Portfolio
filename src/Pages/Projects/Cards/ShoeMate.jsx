          ...
          <div className="flex flex-col h-full">
            ...
            <div className="mt-8">
              <h1 className="text-white text-justify">
                Created this website using PHP and Laravel for my Final Term
                Project in 5th Semester in Web Application course. It is an
                eCommerce website where we add, update, and delete products. It
                was integrated with the payment method also.
              </h1>
            </div>
